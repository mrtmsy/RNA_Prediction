...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 14 01:10:50 2022
...
class DeepProcess():
    ...
    def model_training(self, data_sets):
        ...
        print("train_true_negative:: value: %f" % (tn_t), flush=True)
        print("train_false_positive:: value: %f" % (fp_t), flush=True)
        print("train_false_negative:: value: %f" % (fn_t), flush=True)
        print("train_true_positive:: value: %f" % (tp_t), flush=True)

        print("Done!!")

val_size = 0.1
device = "cpu"
base_path = "/Users/sho/Documents/support/murata"
pos_path = base_path + "/dataset/train_positive.fa"
neg_path = base_path + "/dataset/train_negative.fa"
...
pros = DeepProcess(out_path, params, model_cfg, device = device)
pros.model_training(data.values.tolist())
